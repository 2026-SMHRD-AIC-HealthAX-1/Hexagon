...
# 샘플 수집 구간(0.5~3.8s, 3.8 미포함)과 다음 포인트 전환(4.0s) 경계를 모두
# 지나가 본다. 경계값 자체(0.5/3.8/4.0)는 일부러 안 쓴다 - point_base(예: 32.0)
# + 경계값(예: 3.8) 을 더했다가 다시 빼는 부동소수점 연산이 어느 쪽으로
...
PHASE_OFFSETS = [0.0, 0.3, 0.499, 0.501, 0.6, 1.0, 2.0, 3.0, 3.7, 3.799, 3.801, 3.9, 3.999, 4.001]
...
for point_index in range(9):
    ...
    # 값)" 만큼씩 누적된다 - 4.0 이 아니라 PHASE_OFFSETS[-1](4.001) 이어야
